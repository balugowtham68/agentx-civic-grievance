...
| Member | Contribution |
|---|---|
| **GOWTHAM BALU** | Team Lead, AI Architecture, Agent Orchestration, LLM Integration |
| **GUTTULA GOWTHAM GANDHI** | AI/ML, RAG, Classification & Reasoning |
| **KURELLA PARDHU** | Backend, FastAPI, Mock API, Persistent State |
| **NEDAM HARSHAVARDHAN** | Frontend, UX, Voice/Text, Tracking & Audit UI |
| **K. LAKSHMI NARASIMHA CHARAN** | Watchdog, SLA Monitoring, Escalation, Testing & Integration |
